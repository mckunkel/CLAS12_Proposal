...
\end{align}
and characterizes the intrinsic spatial charge radius for the $\etaP$ meson, and the $\phi \to \eta$ transition for the $\phi$ meson. Several theoretical approaches have been developed to describe the transition form factor and are listed in Tab.~\ref{tab:theory}.
\input{tables/models}
 \begin{figure}[h!]\begin{center}
